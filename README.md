...
The value of each element in the array is either 1 (yellow) or 0 (blue). Rules involving 'triplets' of array values determine the next value of the element at the triplet's center. Every possible triplet is considered - 000, 001, 010, 100, 101, etc. Every triplet type has a corresponding output value (1 or 0). Changing the output values results in varying system behaviour.
